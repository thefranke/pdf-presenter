...
#define VERSION "0.1a"
#define DESCRIPTION "      A dual-screen presentation tool for PDF slides.\n\
This program is distributed under the new BSD license.\n\
Feel free to contact me at tob.franke@googlemail.com."
